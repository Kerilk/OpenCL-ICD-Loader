...
if __name__ == "__main__":
    ...
    try:
        ...
        test = open(args.directory + '/cl_instance_layer.h', 'wb')
        cl_instance_layer_header_template = Template(filename='cl_instance_layer.h.mako')
        test.write(
          cl_instance_layer_header_template.render_unicode(
              spec=spec,
              apisigs=apisigs,
              coreapis=coreapis,
              extapis=extapis).
