...
if __name__ == "__main__":
    ...
    try:
        ...
        test = open(args.directory + '/icd_instance_print_layer_generated.c', 'wb')
        icd_layer_generated_template = Template(filename='icd_instance_print_layer_generated.c.mako')
        test.write(
