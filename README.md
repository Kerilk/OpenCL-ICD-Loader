...
| OCL_LAYERS                        | On Linux and Android, specifies a directory to scan for layers to enumerate in place of the default `/etc/OpenCL/layers'. | `export OCL_ICD_VENDORS=/my/local/layers/search/path` |
